  ...
  return (
    ...
    <Signup />
      ...
      <div className="container mx-auto">
        ...
        {/* <footer className=" bg-[#6549F6] text-white mt-2 md:p-24">
        <div className="flex justify-center  px-6 pt-6 ">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 md:gap-20">
            <div className="mb-6">
              <h5 className=" font-bold mb-2.5 footertitle">Placeholder</h5>
              <ul className="list-none mb-0 footersubtitle">
                <li>
