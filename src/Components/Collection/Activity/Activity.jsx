        ...
        <>
            ...
            <div className="flex justify-between mx-auto container mt-40 flex-wrap">
                <div className="flex justify-between w-full">
                    <img
                        className="rounded-full bg-white w-fit h-fit"
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <div className="flex gap-8 items-center">
                            <div>
                                <svg
                                    className="rounded-full bg-[#F4EEFF] p-[10px]"
                                    width="40"
                                    height="40"
                                    viewBox="0 0 20 18"
                                    fill="none"
                            ...
                            <div>
                                ...
                                >
                                    <path
                                        d="M15.6055 0.761719H4.39453C2.3125 0.761719 0.625 2.44922 0.625 4.53125V15.4688C0.625 17.5508 2.3125 19.2383 4.39453 19.2383H15.6055C17.6875 19.2383 19.375 17.5508 19.375 15.4688V4.53125C19.375 2.44922 17.6875 0.761719 15.6055 0.761719ZM10 14.4141C7.5625 14.4141 5.58594 12.4375 5.58594 10C5.58594 7.5625 7.5625 5.58594 10 5.58594C12.4375 5.58594 14.4141 7.5625 14.4141 10C14.4141 12.4375 12.4375 14.4141 10 14.4141ZM15.6914 5.47266C15.1719 5.47266 14.75 5.05078 14.75 4.53125C14.75 4.01172 15.1719 3.58984 15.6914 3.58984C16.2109 3.58984 16.6328 4.01172 16.6328 4.53125C16.6328 5.05078 16.2109 5.47266 15.6914 5.47266Z"
                                        fill="#6549F6"
                                    />
                                </svg>
                            </div>
                            <div>
                                ...
                                >
                                    <path
                                        d="M18.8707 2.40342C16.3097 0.487219 13.8563 0.540898 13.8563 0.540898L13.6055 0.827338C16.6501 1.74078 18.0649 3.08388 18.0649 3.08388C13.7091 0.685658 8.16071 0.702818 3.63002 3.08388C3.63002 3.08388 5.09853 1.66906 8.32219 0.755618L8.1431 0.540678C8.1431 0.540678 5.70748 0.486998 3.12864 2.4032C3.12864 2.4032 0.549805 7.04168 0.549805 12.7546C0.549805 12.7546 2.05417 15.3335 6.01218 15.4589C6.01218 15.4589 6.67482 14.6708 7.21206 13.9904C4.93748 13.3099 4.07794 11.8951 4.07794 11.8951C5.50684 12.7892 6.9518 13.3489 8.75229 13.7039C11.6818 14.307 15.3257 13.687 18.0471 11.8951C18.0471 11.8951 17.1517 13.3458 14.8056 14.0084C15.3428 14.6711 15.9876 15.4411 15.9876 15.4411C19.9452 15.3159 21.4496 12.737 21.4496 12.7549C21.4496 7.0419 18.8707 2.40342 18.8707 2.40342ZM7.65954 11.0895C6.65656 11.0895 5.83288 10.2119 5.83288 9.11936C5.90614 6.50312 9.43143 6.51126 9.48643 9.11936C9.48621 10.2119 8.68034 11.0895 7.65954 11.0895ZM14.1964 11.0895C13.1934 11.0895 12.3697 10.2119 12.3697 9.11936C12.4503 6.50818 15.9315 6.50708 16.0233 9.11936C16.0231 10.2119 15.2172 11.0895 14.1964 11.0895Z"
                                        fill="#6549F6"
                                    />
                                </svg>
                            </div>
                            <div>
                                ...
                                >
                                    <path
                                        d="M2.4 4.8C1.76348 4.8 1.15303 4.54714 0.702944 4.09706C0.252857 3.64697 0 3.03652 0 2.4C0 1.76348 0.252857 1.15303 0.702944 0.702944C1.15303 0.252856 1.76348 0 2.4 0C3.03652 0 3.64697 0.252856 4.09705 0.702944C4.54714 1.15303 4.8 1.76348 4.8 2.4C4.8 3.03652 4.54714 3.64697 4.09705 4.09706C3.64697 4.54714 3.03652 4.8 2.4 4.8ZM2.4 12C1.76348 12 1.15303 11.7471 0.702944 11.2971C0.252857 10.847 0 10.2365 0 9.6C0 8.96348 0.252857 8.35303 0.702944 7.90294C1.15303 7.45286 1.76348 7.2 2.4 7.2C3.03652 7.2 3.64697 7.45286 4.09705 7.90294C4.54714 8.35303 4.8 8.96348 4.8 9.6C4.8 10.2365 4.54714 10.847 4.09705 11.2971C3.64697 11.7471 3.03652 12 2.4 12ZM2.4 19.2C1.76348 19.2 1.15303 18.9471 0.702944 18.4971C0.252857 18.047 0 17.4365 0 16.8C0 16.1635 0.252857 15.553 0.702944 15.1029C1.15303 14.6529 1.76348 14.4 2.4 14.4C3.03652 14.4 3.64697 14.6529 4.09705 15.1029C4.54714 15.553 4.8 16.1635 4.8 16.8C4.8 17.4365 4.54714 18.047 4.09705 18.4971C3.64697 18.9471 3.03652 19.2 2.4 19.2Z"
                                        fill="#6549F6"
                                    />
                                </svg>
                            </div>
            ...
            <div className="mx-auto container flex justify-start my-10">
                <p className="text-base lg:w-5/12 ">
                    ...
                    Bored Ape to a vial of MUTANT SERUM or by minting a Mutant
                    Ape in the public sale.
                </p>
            </div>
            {/* 4th element */}
